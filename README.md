...
```
constitution=1.15.0   conformance_kit=0.9.0   federation_sdk=0.4.0
registry_checker=1.4.0   boundary_checker=1.1.0   package_date=2026-08-29
```
...
```bash
pip install "liceu-protocol @ git+https://github.com/laverssiera/liceu-protocol@v0.9.0"
```
...
LICEU_CONFORMANCE_STRICT=1 python liceu_conformance.py --self-test   # 59/59
